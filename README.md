...
```bash
# 拉取预构建镜像
docker pull ghcr.io/nianyi778/MoonTV:latest

# 运行容器
# -d: 后台运行  -p: 映射端口 3000 -> 3000
docker run -d --name moontv -p 3000:3000 --env PASSWORD=your_password ghcr.io/nianyi778/MoonTV:latest
```
...
services:
  moontv:
    image: ghcr.io/nianyi778/MoonTV:latest
