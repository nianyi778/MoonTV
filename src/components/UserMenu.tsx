...
export const UserMenu: React.FC = () => {
  ...
  const menuPanel = (
    <>
      ...
      {/* 菜单面板 */}
      <div className='fixed top-14 right-4 w-56 bg-[#1a1a1a] rounded-lg shadow-xl z-[1001] border border-white/10 overflow-hidden select-none'>
        {/* 用户信息区域 */}
        ...
        <div className='py-1'>
          ...
          <button
            ...
            className='w-full px-3 py-2 text-left flex items-center gap-2.5 text-gray-300 hover:bg-white/10 transition-colors text-sm'
          >
          ...
          <button
            ...
            className='w-full px-3 py-2 text-left flex items-center gap-2.5 text-red-400 hover:bg-red-500/10 transition-colors text-sm'
          >
          ...
          <button
            ...
            className='w-full px-3 py-2 text-center flex items-center justify-center text-gray-400 hover:bg-white/5 transition-colors text-xs'
          >
  ...
  const settingsPanel = (
    <>
      ...
      {/* 设置面板 */}
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-[#1a1a1a] rounded-xl shadow-xl z-[1001] p-6'>
        {/* 标题栏 */}
        <div className='flex items-center justify-between mb-6'>
          <div className='flex items-center gap-3'>
            <h3 className='text-xl font-bold text-white'>本地设置</h3>
            <button
              onClick={handleResetSettings}
              className='px-2 py-1 text-xs text-red-400 hover:text-red-300 border border-red-500/30 hover:border-red-500/50 hover:bg-red-500/10 rounded transition-colors'
              title='重置为默认设置'
            >
              重置
            </button>
          ...
          <button
            onClick={handleCloseSettings}
            className='w-8 h-8 p-1 rounded-full flex items-center justify-center text-gray-500 hover:bg-white/10 transition-colors'
            aria-label='Close'
          >
          ...
          <div className='flex items-center justify-between'>
            ...
            <label className='flex items-center cursor-pointer'>
              <div className='relative'>
                ...
                />
                <div className='w-11 h-6 bg-white/20 rounded-full peer-checked:bg-brand-500 transition-colors'></div>
          ...
          <div className='space-y-3'>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors ${
                enableDoubanProxy
                  ? 'border-white/20 bg-white/5 text-white placeholder-gray-500'
                  : 'border-white/10 bg-gray-50 dark:bg-gray-800/50 text-gray-500 placeholder-gray-400 dark:placeholder-gray-600 cursor-not-allowed'
              }`}
      ...
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-[#1a1a1a] rounded-xl shadow-xl z-[1001] p-6'>
        ...
        <div className='space-y-4'>
          ...
          <div>
            ...
            <input
              type='password'
              className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors bg-white dark:bg-gray-800 text-white placeholder-gray-500'
              placeholder='请输入新密码'
              value={newPassword}
        ...
        <div className='flex gap-3 mt-6 pt-4 border-t border-white/10'>
          <button
            onClick={handleCloseChangePassword}
            className='flex-1 px-4 py-2 text-sm font-medium text-gray-300 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md transition-colors'
            disabled={passwordLoading}
          >
            取消
          </button>
